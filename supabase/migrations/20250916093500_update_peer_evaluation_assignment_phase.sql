-- Ensure peer evaluation phase records are updated when assignments are created
...
BEGIN
    ...
    IF target_class IS NULL THEN
        PERFORM public.update_peer_evaluation_phase(activity_id_param, class_list.class_name, 'peer-evaluation')
        FROM (
    ...
    ELSE
        PERFORM public.update_peer_evaluation_phase(activity_id_param, target_class, 'peer-evaluation');
    END IF;
